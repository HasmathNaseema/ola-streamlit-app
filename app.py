...
with tab2:
    ...
    # IMPORTANT: Replace this with your actual "Publish to web" URL
    ...
    if "PASTE_YOUR_POWERBI" in powerbi_url:
        st.warning("Paste your Power BI Publish-to-web URL in `powerbi_url` to display the dashboard.")
    else:
        components.iframe(powerbi_url, height=750, scrolling=True)
...
with tab1:
    ...
    # Combine final SQL safely (insert WHERE before GROUP BY / ORDER BY / LIMIT)
